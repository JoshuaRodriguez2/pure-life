    ...
    <section id="contact" className="contact section">
      <div className="container">
        <div className="contact-header">
          <h2 className="heading-2">Get Started Today</h2>
          <p className="text-lg">
            Ready to transform your health? Get in touch to discuss your needs 
            and learn how we can help you achieve optimal wellness.
          </p>
        </div>
        ...
        <div className="contact-content">
          ...
          <div className="contact-form-container">
            <div className="form-card">
              <h3>Get in Touch</h3>
              <p>Fill out the form below and we'll contact you to discuss your health needs.</p>
              ...
              <form onSubmit={handleSubmit} className="contact-form">
                ...
                <div className="form-group">
                  ...
                  >
                    ...
                    <option value="comprehensive-assessment">Comprehensive Health Assessment</option>
                    <option value="hormone-optimization">Hormone Optimization</option>
                    <option value="gut-health-restoration">Gut Health Restoration</option>
                    <option value="detoxification-program">Detoxification Program</option>
                    <option value="at-home-lab-testing">At-Home Lab Testing & Monitoring</option>
                    <option value="preventive-care">Preventive Care & Wellness</option>
                ...
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="4"
                    placeholder="Tell us about your health goals and concerns..."
                  ></textarea>
                </div>
